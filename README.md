...
It is maintained by the LXQt project but can be used independently from this desktop environment. The only bond is [lxqt-build-tools](https://github.com/lxqt/lxqt-build-tools) representing a build dependency.
...
Dependencies are Qt ≥ 5.7.1 and [QTermWidget](https://github.com/lxqt/qtermwidget).
In order to build CMake ≥ 3.1.0 and [lxqt-build-tools](https://github.com/lxqt/lxqt-build-tools) are needed as well. Please refer to this repository's `README.md` for further information.
